...
that is used to encode the magnetic stripe found on Driver's Licenses in the US and Canada.
Most data is available both in its raw and decoded form. You should refer to the latest specification at
www.aamva.org for details on the field contents. 

Starting and ending sentinals in the track data are optional.

This is an object oriented module due to the large number of fields involved.

Load the tracks you have available.  Not all magnetic stripe readers can read track 3. 
...
restrictions    License Restrictions    6                               3
endorsements    License Endorsements    7                               3
...
=item $p->loadtrack(trackno,string);
...
Attempts to determine country of origin from the
ISO ID.  Returns CAN, MEX or USA.
...
=head1 AUTHOR
Curt Evans      curt@net2business.com
=back
=head1 COPYRIGHT
